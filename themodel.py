...
class PuncTensor(object):
	...
	def mini_ver(self):
		mini_version = PuncTensor(name=self.name, size_hidden=self.size_hidden, size_emb=self.size_emb, vocabularized=self.vocabularized, vocabulary_size=self.vocabulary_size, bidirectional=self.bidirectional)
		return mini_version
